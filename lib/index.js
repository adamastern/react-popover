...
const flowToPopoverTransitions = {
  row: 'left',
  column: 'top'
};
...
const Popover = createClass({
  ...
  animateEnter () {
    ...
    var transitionProperties = ['opacity','transform', flowToPopoverTranslations[this.zone.flow]];

    this.containerEl.style.transitionProperty = transitionProperties.join(', ');
