...
const createElement = x => isClient ? document.createElement(x) : noop;

const bodyAppendElement = x => isClient ? document.body.appendChild(x) : noop;

const bodyRemoveElement = x => isClient ? document.body.removeChild(x) : noop;
