...
const requestAnimationFrame = isServer ? noop : window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || (fn => {
  window.setTimeout(fn, 20);
});

const cancelAnimationFrame = isServer ? noop : window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.clearTimeout;
